...
export class OverviewComponent implements OnInit {
  ...
  constructor(
   ...
   headerDataGoals :any = [];bodyDataGoals :any = []; dataGoals :any;
   headerDataXg : any =[];bodyDataXg : any =[]; dataXG :any;
   headerDataTirs : any = [];bodyDataTirs : any =[]; dataTirs: any;
   headerDataTirCadre : any = []; bodyDataTirCadre :any =[]; dataTirsCadres:any;
   headerDataButsCon :any =[]; bodyDataButsCon :any =[]; dataButsConcedes:any;
   headerDataXgAgain : any=[];bodyDataXgAgain :any =[]; dataXgAgain : any;
   headerDataTirsContre : any=[];bodyDataTirsContre :any =[];dataTirsContre :any;
   headerDataTirsContreCadre : any=[];bodyDataTirsContreCadre :any =[]; dataTirsContreCadre :any;
   headerDataFautes : any=[];bodyDataFautes :any =[]; dataFautes:any;
   headerDataCarteJoune : any =[];bodyDataCarteJoune : any =[]; dataCartonsJaunes :any;
   headerDataCarteRouge : any =[];bodyDataCarteRouge : any =[]; dataCartonsRouges:any;
   headerDataPossession : any=[]; bodyDataPossession : any = []; dataPossession:any;
...
getRankingInfos(){
  this.teamsService.getRankingInfo().subscribe((res :any[])=>{
    ...
    this.headerDataTirsContreCadre = res['Tirs_contre_cadres'][0]['header'][0];
