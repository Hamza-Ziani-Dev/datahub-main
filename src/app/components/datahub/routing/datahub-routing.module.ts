    ...
    path: '', component: DatahubComponent, canActivate: [DatahubGuard], children: [
      {
        path: 'ranking', component: RankingComponent, children: [
          ...
          { path: 'profile-player/:id/:player_id', component: RankingProfilePlayerComponent },
        ]
      },
      {
        path: 'database', component: DatabaseComponent, children: [
          ...
          {
            path: 'profile-player/:player_id', component: DatabaseProfilePlayerComponent, children: [
