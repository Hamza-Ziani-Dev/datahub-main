...
const routes: Routes = [
  {
    path: '', component: DatahubComponent, canActivate: [DatahubGuard, AuthGuard], children: [
      {
        path: 'ranking', component: RankingComponent, children: [
          ...
          { path: 'list-players-post/:id/:category', component: RankingListPlayersPostComponent },
          { path: 'profile-player/:player_id', component: RankingProfilePlayerComponent },
        ]
      },
      {
        path: 'database', component: DatabaseComponent, children: [
          { path: '', component: DatabaseListPlayersPostComponent },
          { path: 'list-players-post', component: DatabaseListPlayersPostComponent },
          {
            path: 'profile-player/:player_id/:ligue', component: DatabaseProfilePlayerComponent, children: [
              { path: 'player-resume', component: DatabasePlayerResumeComponent },
              { path: 'player-performance', component: DatabasePlayerPerformanceComponent },
              { path: 'player-medicale', component: DatabasePlayerMedicaleComponent },
              { path: 'player-individuelle', component: DatabasePlayerIndividuelleComponent },
            ]
          },
        ]
      },
